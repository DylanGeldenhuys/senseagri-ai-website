  ...
  return (
    <div>
      ...
      <PageHero
        ...
        sub="AI poultry monitoring for your farm, however big — environmental sensors, computer vision, acoustic welfare signals, gut-health intelligence, production reporting, and early disease alerts running continuously in every house."
      />
