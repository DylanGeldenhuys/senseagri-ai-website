        ...
        <div className="mx-auto max-w-6xl grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-start">
          ...
          <div className="lg:pt-1">
            <p className="font-sans text-base leading-relaxed text-on-surface-variant">
              SenseAgri AI is a poultry decision-intelligence platform for farms of every size across Africa. Our mission is to close the intelligence gap: generate insights and automation with real ROI, understand cause and effect, and empower every farmer to make data-driven decisions — regardless of scale.
            </p>
            <Link
              href="/solution"
