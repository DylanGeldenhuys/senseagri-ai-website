  ...
  "@graph": [
    {
      ...
      description:
        "AI decision-intelligence platform for poultry farms of every size. Unifies farm sensor data into welfare, production and ROI insights with edge AI alerts.",
